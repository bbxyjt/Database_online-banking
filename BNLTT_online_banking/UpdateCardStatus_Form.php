...
<div class="container">
    <form name="inpfrm" method="post" action="UpdateCardStatus_Insert.php">
        <table class="form-table">
            <tr>
                <td colspan="2" class="form-header">Update customer's card status <box-icon type='card' name='edit' color = 'white'></box-icon></td>
            </tr>
            <tr>
                <td align="right">Customer's Card Number:</td>
                <td align="left"><input name="Card_Number" type="text" id="Card_Number" size="30" value="" maxlength="30"></td>
            </tr>
            <tr>
                <td align="right">Card Status:</td>
                <td>
