...
<body>
    <div class="container">
        ...
        <h1>BNLTT Employee</h1>

        <div class="button-container">
            <form method="POST" action="EmployeeLoginForm.php">
                <input type="submit" name="login" value="Login" class="block-button">
            </form>

            <form method="POST" action="EmployeeForm.php">
                <input type="submit" name="signup" value="Register" class="block-button">
            </form>
        </div>
    </div>
</body>