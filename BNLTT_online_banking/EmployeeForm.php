...
<head>
    ...
    <style>
        ...
        .input-field {
            ...
            color: #000000;
            border-radius: 5px;
            font-family: 'Ubuntu', sans-serif; /* Added font family */
        }
...
<body>
  <div class="container">
    ...
    <form name="inpfrm" method="post" action="Employee.php">
    <div class="form-group">
                <label class="label">First Name:</label>
                <input name="Employee_First_Name" type="text" id="Employee_First_Name" class="input-field" size="30" value=""
                    maxlength="30" />
            </div>
            <div class="form-group">
                <label class="label">Last Name:</label>
                <input name="Employee_Last_Name" type="text" id="Employee_Last_Name" class="input-field" size="30" value=""
                    maxlength="30" />
            </div>
            <div class="form-group">
                <label class="label">Sex:</label>
                <label class="bodyy"><input type="radio" name="Sex" value="Male" />Male</label>
                <label class="bodyy"><input type="radio" name="Sex" value="Female" />Female</label>
            </div>
            <div class="form-group">
      ...
      <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="Employee_Email" type="text" id="Employee_Email" class="input-field" size="30" value=""
                    maxlength="30" />
            </div>
            <div class="form-group">
                <label class="label">Phone Number:</label>
                <input name="Employee_Phone_Number" type="text" id="Employee_Phone_Number" class="input-field" size="10" value=""
                    maxlength="10" />
             <div class="form-group">
      ...
      <div class="button-container">
      <a href="indexEmployee.php" class="button">Back</a>
    </div>
